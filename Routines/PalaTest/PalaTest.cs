...
using FollowHer.Routines.PalaTest.Strategy;
...
namespace FollowHer.Routines.PalaTest
{
    public class PalaTest : OrbWalkingRoutineBase
    {
        ...
        public PalaTest(GameController gameController)
