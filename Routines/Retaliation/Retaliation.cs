...
using FollowHer.Routines.Retaliation.Strategy;
...
namespace FollowHer.Routines.Retaliation
{
    public class Retaliation : OrbWalkingRoutineBase
    {
        ...
        public Retaliation(GameController gameController)
            : base("Retaliation", gameController)
        {
