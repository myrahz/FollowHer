...
using FollowHer.Routines.PaladinSupp.Strategy;
...
namespace FollowHer.Routines.PaladinSupp
{
    public class PaladinSupp : OrbWalkingRoutineBase
    {
        ...
        public PaladinSupp(GameController gameController)
            : base("PaladinSupp", gameController)
        {
